class Game {
    ...
    drawPlayer() {
        if (this.imagesLoaded && this.images.hotdog.complete) {
    ...
    // Draw projectiles (mustard blasts) - Enhanced visibility
    drawProjectiles() {
        this.projectiles.forEach(proj => {
            // Enhanced yellow laser with glow effect
            this.ctx.shadowColor = '#FFFF00';
            this.ctx.shadowBlur = 10;
            this.ctx.fillStyle = '#FFFF00'; // Brighter yellow
            this.ctx.beginPath();
            this.ctx.arc(proj.x, proj.y, 7, 0, Math.PI * 2); // Larger size
            this.ctx.fill();
